          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 pointer-events-none z-20">
                  <div className="bg-gradient-to-r from-primary-600 to-purple-600 text-white text-xs rounded-lg shadow-lg px-3 py-2 whitespace-nowrap">
                    We respect your privacy. Full policy coming soon.
                  </div>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-purple-600 rotate-45 -mt-1"></div>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 pointer-events-none z-20">
                  <div className="bg-gradient-to-r from-primary-600 to-purple-600 text-white text-xs rounded-lg shadow-lg px-3 py-2 whitespace-nowrap">
                    Our terms of service are being finalized. Full policy coming soon.
                  </div>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-purple-600 rotate-45 -mt-1"></div>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 pointer-events-none z-20">
                  <div className="bg-gradient-to-r from-primary-600 to-purple-600 text-white text-xs rounded-lg shadow-lg px-3 py-2 whitespace-nowrap">
                    We use cookies to improve your experience. Full policy coming soon.
                  </div>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-purple-600 rotate-45 -mt-1"></div>
                </div>
              </a>
              ...
              >
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 pointer-events-none z-20">
                  <div className="bg-gradient-to-r from-primary-600 to-purple-600 text-white text-xs rounded-lg shadow-lg px-3 py-2 whitespace-nowrap">
                    Have a question or issue? Reach out to us here.
                  </div>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-purple-600 rotate-45 -mt-1"></div>
                </div>
              </Link>
